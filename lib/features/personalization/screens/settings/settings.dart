        ...
        child: Column(
          children: [
            /// Header
                ...
                PrimaryHeaderController(child: Column(
                  children: [
                    /// Appbar
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems,),
                  const SettingsMenuTile(icon: Iconsax.document_upload, title: 'Load Data', subTitle: 'Upload data to your API'),
                  SettingsMenuTile(icon: Iconsax.security_user, title: 'Safe Mode', subTitle: 'Search Result is safe for all pages', trailing: Switch(value: false, onChanged: (value) {}),),
